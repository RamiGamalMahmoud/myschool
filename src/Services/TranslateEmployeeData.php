...
class TranslateEmployeeData
{
    ...
    public static function translatePersonalData(array $personalData): array
    {
        $translateData  = [
            ...
            'gender' => ['key' => $personalData['gender'], 'value' => Translate::get('gender', $personalData['gender'])],
            'religion' => ['key' => $personalData['religion'], 'value' => Translate::get('religion', $personalData['religion'])],
            'nationality' => ['key' => $personalData['nationality'], 'value' => Translate::get('nationality', $personalData['nationality'])]
        ];
        return $translateData;
    }
    ...
    {
        $translateData = [
            'martial-status' => ['key' => $socialData['martial-status'], 'value' => Translate::get('martial-status', $socialData['martial-status'])],
    ...
    public static function translateJobData(array $jobData): array
    {
        $translateData = [
            ...
            'employee-type' => ['key' => $jobData['employee-type'], 'value' => Translate::get('job-data.employee-type', $jobData['employee-type'])],
            'employee-status' => ['key' => $jobData['employee-status'], 'value' => Translate::get('job-data.employee-status', $jobData['employee-status'])],
            'attitude-to-work' => ['key' => $jobData['attitude-to-work'], 'value' => Translate::get('job-data.attitude-to-work', $jobData['attitude-to-work'])]
        ];
        return $translateData;
    }
}
